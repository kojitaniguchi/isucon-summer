...
#line 623 "xs-src/MouseTypeConstraints.c"
...
#line 767 "xs-src/MouseTypeConstraints.c"
#ifdef USE_ITHREADS
...
XS_EUPXS(XS_Mouse__Util__TypeConstraints_CLONE)
{
    ...
    {
#line 650 "xs-src/MouseTypeConstraints.xs"
{
    MY_CXT_CLONE;
    setup_my_cxt(aTHX_ aMY_CXT);
    PERL_UNUSED_VAR(items);
}
#line 784 "xs-src/MouseTypeConstraints.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_Mouse__Util__TypeConstraints__parameterize_ArrayRef_for)
{
	...
	SV*	param = ST(0)
;
#line 669 "xs-src/MouseTypeConstraints.xs"
{
    check_fptr_t fptr;
...
#line 825 "xs-src/MouseTypeConstraints.c"
	{
	    SV * RETVALSV;
...
XS_EUPXS(XS_Mouse__Meta__TypeConstraint__identity)
{
	...
	SV*	self = ST(0)
;
#line 746 "xs-src/MouseTypeConstraints.xs"
{
    if(!SvROK(self)) {
...
#line 855 "xs-src/MouseTypeConstraints.c"
...
XS_EUPXS(XS_Mouse__Meta__TypeConstraint_compile_type_constraint)
{
	...
	SV*	self = ST(0)
;
#line 758 "xs-src/MouseTypeConstraints.xs"
{
...
#line 944 "xs-src/MouseTypeConstraints.c"
    }
    XSRETURN_EMPTY;
}
...
;
	SV*	sv = ST(1)
;
#line 834 "xs-src/MouseTypeConstraints.xs"
{
...
#line 982 "xs-src/MouseTypeConstraints.c"
	ST(0) = boolSV(RETVAL);
    }
    XSRETURN(1);
}
...
#line 619 "xs-src/MouseTypeConstraints.xs"
{
    MY_CXT_INIT;
    setup_my_cxt(aTHX_ aMY_CXT);
...
#if XSubPPtmpAAAA
#endif
#line 694 "xs-src/MouseTypeConstraints.xs"
...
#line 1107 "xs-src/MouseTypeConstraints.c"
