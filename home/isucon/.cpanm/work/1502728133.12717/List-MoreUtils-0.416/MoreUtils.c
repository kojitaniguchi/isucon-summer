...
;
	int	RETVAL;
	dXSTARG;
#line 522 "MoreUtils.xs"
{
    I32 count = 0;
    FOR_EACH(if (SvTRUE(*PL_stack_sp)) count++);
    RETVAL = count;
}
#line 803 "MoreUtils.c"
...
;
	int	RETVAL;
	dXSTARG;
#line 535 "MoreUtils.xs"
{
    I32 count = 0;
    FOR_EACH(if (!SvTRUE(*PL_stack_sp)) count++);
    RETVAL = count;
}
#line 827 "MoreUtils.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_List__MoreUtils_each_array)
{
    ...
    {
	SV *	RETVAL;
#line 1113 "MoreUtils.xs"
    {
	EACH_ARRAY_BODY;
    }
#line 1612 "MoreUtils.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_List__MoreUtils_each_arrayref)
{
    ...
    {
	SV *	RETVAL;
#line 1122 "MoreUtils.xs"
    {
	EACH_ARRAY_BODY;
    }
#line 1631 "MoreUtils.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_List__MoreUtils__XScompiled)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 1813 "MoreUtils.xs"
       XSRETURN_YES;
#line 2452 "MoreUtils.c"
    }
    XSRETURN_EMPTY;
}
