...
# -MD kernel/.bounds.s.d /build/linux-As38az/linux-4.4.0/kernel/bounds.c
...
1:	call	__fentry__
	...
	movq	%rsp, %rbp	#,
#APP
# 18 "/build/linux-As38az/linux-4.4.0/kernel/bounds.c" 1
	
->NR_PAGEFLAGS $26 __NR_PAGEFLAGS	#
# 0 "" 2
# 19 "/build/linux-As38az/linux-4.4.0/kernel/bounds.c" 1
	
->MAX_NR_ZONES $5 __MAX_NR_ZONES	#
# 0 "" 2
# 21 "/build/linux-As38az/linux-4.4.0/kernel/bounds.c" 1
	
->NR_CPUS_BITS $9 ilog2(CONFIG_NR_CPUS)	#
# 0 "" 2
# 23 "/build/linux-As38az/linux-4.4.0/kernel/bounds.c" 1
